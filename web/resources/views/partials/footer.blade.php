...
<footer class="dark-bg">
    <div class="container inner">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 inner">
                <h4>Who we are</h4>
                <a href="index.html"><img class="logo img-intext" src="{{ asset('images/logo-white.svg') }}" alt=""></a>
                ...
                <div class="row thumbs gap-xs">
                    ...
                    <div class="col-xs-6 thumb">
                        <figure class="icon-overlay icn-link">
                            <a href="portfolio-post.html"><img src="{{ asset('images/art/work02.jpg') }}" alt=""></a>
                        </figure>
                    </div><!-- /.thumb -->

                    <div class="col-xs-6 thumb">
                        <figure class="icon-overlay icn-link">
                            <a href="portfolio-post.html"><img src="{{ asset('images/art/work03.jpg') }}" alt=""></a>
                        </figure>
                    </div><!-- /.thumb -->

                    <div class="col-xs-6 thumb">
                        <figure class="icon-overlay icn-link">
                            <a href="portfolio-post.html"><img src="{{ asset('images/art/work07.jpg') }}" alt=""></a>
                        </figure>
                    </div><!-- /.thumb -->

                    <div class="col-xs-6 thumb">
                        <figure class="icon-overlay icn-link">
                            <a href="portfolio-post.html"><img src="{{ asset('images/art/work01.jpg') }}" alt=""></a>
                        </figure>
                    </div><!-- /.thumb -->
            ...
            <div class="col-md-3 col-sm-6 inner">
                ...
                <ul class="contacts">
                    <li><i class="icon-location contact"></i> Varaždin</li>
                    <li><i class="icon-mobile contact"></i> +385 97 615 5988</li>
                    <li><a href="#"><i class="icon-mail-1 contact"></i> bastion.com</a></li>
                </ul><!-- /.contacts -->
            </div><!-- /.col -->
    ...
    <div class="footer-bottom">
        <div class="container inner">
            <p class="pull-left">2015 Bastion © Ready Steady Code 2.0</p>
